...
ActiveRecord::Schema.define(:version => 20121105070956) do
  ...
  create_table "cini_followers", :force => true do |t|
    t.integer  "user_id"
    t.integer  "cini_id"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
  ...
  add_index "cini_followers", ["cini_id"], :name => "index_cini_followers_on_cini_id"
  add_index "cini_followers", ["user_id"], :name => "index_cini_followers_on_user_id"

  create_table "cini_roles", :force => true do |t|
    t.integer  "cini_id"
    t.integer  "user_id"
    t.integer  "role_id"
  ...
  create_table "cinis", :force => true do |t|
    t.datetime "created_at",                      :null => false
    t.datetime "updated_at",                      :null => false
    t.string   "one_sheet"
    t.text     "synopsis"
  ...
  create_table "facet_tags", :force => true do |t|
    t.string "context"
    t.string "tag_name"
  end
  ...
  create_table "update_feeds", :force => true do |t|
    t.integer  "user_id"
    t.text     "alert"
